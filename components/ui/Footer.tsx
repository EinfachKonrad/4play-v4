...
export default function Footer() {
  ...
  return (
    <footer className="w-full border-t border-gray-800 py-4 text-center text-sm text-gray-500">
        {/* <p className='text-gray-400 text-base'>{instanceConfig?.name}</p> */}
        <p className='text-gray-400 text-base'>4play {process.env.NEXT_PUBLIC_APP_VERSION}</p>
