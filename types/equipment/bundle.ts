export default interface Bundle {
    ...
    contents: Array<{
        id: string;   // item or bundle id (i-xxx or b-xxx)
        ...
        versionUuid?: string;   // version id (v-xxx) if the item has different versions and a specific version is included in the bundle, otherwise it can be left empty to indicate that any version of the item can be included in the bundle
    }>;

    elements?: Array<{
        id: string;   // element id (e-xxx)
        ...
        history: Array<{
            ...
            updatedBy: string; // user id (u-xxx) who updated the status last time
        }>;
        verificationHistory: Array<{
            ...
            verifiedBy: string; // user id (u-xxx) who performed the verification
        }>;
    }>;
}