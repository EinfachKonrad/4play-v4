export default interface Bundle {
    ...
    contents: Array<{
        ...
        versionUuid?: string;   // version id if the item has different versions and a specific version is included in the bundle, otherwise it can be left empty to indicate that any version of the item can be included in the bundle
    }>;
    ...
    elements?: Array<{
        ...
        history: Array<{
            ...
            updatedBy: string; // user id who updated the status last time
        }>;
        verificationHistory: Array<{
            ...
            verifiedBy: string; // user id who performed the verification
        }>;
    }>;
}